                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><?php echo"<a href=\"courseDashboardStudentModules.php?moduleID=2&courseID=" . $courseID . "&token=" . sha1($courseID) . ">"; ?><i class="fa fa-circle-o"></i>Basic Structures: Sets, <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Functions, Sequences, <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sums, and Matrices</a></li>
            ...
            <div class="content-wrapper">
                ...
                <section>
                    <center>
                        ...
                        if ($moduleID == 2) {
                            ?>
                            <h3>Mathematics - Sets, Relations & Functions - Lesson 1</h3>
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/jUNajHYVRz8" frameborder="0" allowfullscreen></iframe>
                            <h3>Lecture Notes</h3>
                            <iframe src="http://localhost:1234/kdumooc/contents/2.pdf" style="width:718px; height:700px;" frameborder="0"></iframe>
                            <?php
                        } else if($moduleID == 1){
                           echo  "<h3>No contents available here!</h3>";
                        }
                         else if($moduleID == 3){
                           echo  "<h3>No contents available here!</h3>";
                        }

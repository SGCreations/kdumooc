                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">Sidath Gajanayaka</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
...
<!--                    <form action="#" method="get" class="sidebar-form">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="documentation/index.html"><i class="fa fa-bullhorn"></i> <span>Announcements</span></a></li>
                        ...
                        <li><a href="documentation/index.html"><i class="fa fa-question-circle"></i> <span>Assignments</span></a></li>
<li><a href="documentation/index.html"><i class="fa fa-male"></i> <span>About Your Lecturer</span></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        WELCOME!
                        <small>You are following: <b>Discrete Mathematics I</b></small>
                    </h1>
                    <ol class="breadcrumb">

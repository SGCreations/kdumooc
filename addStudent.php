...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <center>
                <h3>Sign up for KDUMOOC as a Student:</h3></center>
            <br>
            <center>
                <?php
                ...
                ?>
                <form class="form-horizontal" id="register-form" novalidate="novalidate" action='addStudent_submit.php' method="post"> 
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="date" class="form-control" id="idDoB" placeholder="Enter Your Date of Birth" name="dob">
                            </div>
                        </div> 
                        <div class="form-group">

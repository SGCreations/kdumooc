                ...
                JQUERY4U.UTIL =
                        {
                            setupFormValidation: function()
                            {
                                ...
                                $("#register-form").validate({
                                    ...
                                    messages: {
                                        moduleTitle: "This field is mandatory.",
                                        category: "This field is mandatory. Enter a suitable category of the Module, for e.g.: Mathematics, Science etc.",
                                        duration: {
    ...
    <body>
        <div class="container">
            ...
            <center>
                ...
                <?php } ?>
                <form class="form-horizontal" id="register-form" action='addModule_submit.php' method="post" enctype="multipart/form-data">
                    <div class="col-lg-12">

                        <div class="form-group">
                            <label class="control-label col-sm-4" for="idModuleTitle" >Module Title:</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="idModuleTitle" placeholder="Enter the Module Title" name="moduleTitle">
                            </div>
                        </div>  
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <button type="submit" class="submit btn btn-default">Add Module</button>
                            </div>
                        </div>
                    </div>
                </form>

            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><?php echo"<a href=\"courseDashboardStudentAboutLecturer.php?courseID=" . $courseID . "&token=" . sha1($courseID) . "\">"; ?><i class="fa fa-male"></i> <span>About Your Lecturer</span></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section>
                    <center>
                        ...
                        echo $img_url . "<br/>";
                        echo "<p><b>&nbsp;&nbsp;&nbsp;" . $lecturerDetails[0]['first_name'] . " " . $lecturerDetails[0]['last_name'] . "</b></p>";
                        ?>
                        <table style="width: 90%" class="table table-striped table-hover">
                            <tr>
                                <td><b>Qualifications: </b></td>
                                <td><?php echo $lecturerDetails[0]['qualifications']; ?></td>
                            </tr>
                            <tr>
                                <td><b>Email: </b></td>
                                <td><?php echo $lecturerDetails[0]['email']; ?></td>
                            </tr>
                            <tr>
                                <td><b>Affiliated Courses:</b> </td>
                                <td><?php
                                    $list_of_courses = getCoursesOfLecturer($resultsOfCourse[0]['LECTURER_idLECTURER'], $db);

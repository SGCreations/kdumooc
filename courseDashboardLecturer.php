...
if (!sessionExists() || !isStudent()) {
    ...
    $lecturer_details = loadLecturerDetails($_SESSION['userID'], $db);
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?php echo $lecturer_details[0]['first_name'] . " " . $lecturer_details[0]['last_name'] ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            <?php echo $lecturer_details[0]['first_name'] . " " . $lecturer_details[0]['last_name']; ?> - Student
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><?php echo $lecturer_details[0]['first_name'] . " " . $lecturer_details[0]['last_name'] ?></p>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><?php echo"<a href=\"courseDashboardLecturerAssignments.php?courseID=" . $courseID . "&token=" . sha1($courseID) . "\">"; ?><i class="fa fa-question-circle"></i> <span>Assignments</span></a></li>
                        <li><?php echo"<a href=\"courseDashboardLecturerAddQuestions.php?courseID=" . $courseID . "&token=" . sha1($courseID) . "\">"; ?><i class="fa fa-male"></i> <span>Add Question</span></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section id="idMainContent">
                    <center>
                        ...
                        <img src="/kdumooc/images/courses/dm.jpg" width="500px" height="500px"/>
                    </center>
                </section>
            </div><!-- /.content-wrapper -->

...
if (!isset($_GET['courseID']) && (sha1($_GET['courseID']) != $_GET['courseID'])) {
    ...
    <body>
        <div class="container">
            ...
            <center>
                ...
                <?php } ?>
                <form class="form-horizontal" id="register-form" action='editCourse_submit.php' method="post" enctype="multipart/form-data">
                    <div class="col-lg-12">

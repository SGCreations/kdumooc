        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><?php echo"<a href=\"courseDashboardStudentAnnouncements.php?courseID=" . $courseID . "&token=" . sha1($courseID) . "\">"; ?><i class="fa fa-bullhorn"></i> <span>Announcements</span></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section>
                    <center>
                        <br/>
                        <i><h4>You have no announcements.</h4></i>
                        <br/>
                    </center>
                </section>
            </div><!-- /.content-wrapper -->
